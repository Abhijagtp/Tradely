...
export function HomeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2.1">
      ...
      <path d="M6.5 9.5v10h11v-10" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10 19.5v-4.5h4v4.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function ChatIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2.1">
      <path d="M5 6.5h14a2 2 0 0 1 2 2v6.5a2 2 0 0 1-2 2H10l-4.5 3V17H5a2 2 0 0 1-2-2V8.5a2 2 0 0 1 2-2Z" strokeLinecap="round" strokeLinejoin="round" />
